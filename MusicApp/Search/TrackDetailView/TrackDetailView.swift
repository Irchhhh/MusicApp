   ...
   //MARK: - awakeFromNib
    ...
    @IBAction func playPauseAction(_ sender: Any) {
        if player.timeControlStatus == .paused {
            ...
            miniPlayPauseButton.setImage(#imageLiteral(resourceName: "min"), for: .normal)
            enlargeTrackImageView()
        } else {
            player.pause()
            playPauseButton.setImage(#imageLiteral(resourceName: "play"), for: .normal)
            miniPlayPauseButton.setImage(#imageLiteral(resourceName: "playMin"), for: .normal)
    ...
    private func gesturePanChange(gesture: UIPanGestureRecognizer) {
   ...
   //MARK: - Animations
    private func enlargeTrackImageView() {
        UIView.animate(
            ...
            animations: { self.trackImageView.transform = .identity
        } , completion: nil
        )
    }
